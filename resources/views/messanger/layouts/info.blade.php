...
<div class="page-header header-filter single-message" data-parallax="true" style="background-image:url('{{ filePath($user->cover) }}');">
</div>
<div class="main main-raised">
    <div class="profile-content single-message-user-profile py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ml-auto mr-auto">
                    <div class="profile">
                        ...
                        <div class="name">
                            ...
                            @if ($user->id != Auth::id())
                                <h6>
                                    <a href="#" class="custom-danger-btn danger delete-conversation"><i class='bx bx-trash'></i> Delete Conversation</a>
                                </h6>
                            @endif
                        ...
                        <div class="row">
                            <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                                ...
                                {{--<div class="form-group form-outline">--}}
                                    ...
                                    {{--<input type="text" readonly class="form-control" id="user_name" value="{{ $user->name }}" placeholder="Name">--}}
                                {{--</div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control">
                                        <option {{ $user->genders == ' ' ? 'selected' : null }} >Choose...</option>
