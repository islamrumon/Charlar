...
<body>
    <input type="hidden" id="startCall" value="{{ route('start.call', routeValEncode($call->id)) }}">
    <input type="hidden" id="endCall" value="{{ route('end.call', routeValEncode($call->id)) }}">
                                                    ...
                                                    <div class="col text-center pe-0 call-content">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="receiver-img">
                                                                <img src="{{ filePath($fromUser->avatar) }}"
                                                                    width="auto" height="80px" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @else
    ...
    <script>
        ...
        channel.bind("calling", function(data) {
            console.log("calling");
            console.log(data);
            console.log("calling end");
            // if (data.from_id == {{ $call->from_id }} && data.to_id == {{ $call->to_id }}) {
