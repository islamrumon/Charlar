<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="left-side-header col ps-0 d-none d-md-block">
            <div class="input-group  d-none"><span class="input-group-text" id="basic-addon1">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
            ...
            <ul class="nav-menus">
                ...
                <li>
                    <div class="theme-language">
                        <a class="dropdown-btn" href="javascript:void(0)" role="button">
                            <div  class="languagebar m-l-5 m-r-5" id="google_translate_element"></div>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="mode animated backOutRight {{ Cookie::get('darkmood') }}">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    <div class="media profile-media">
                        @php
                            $user = Auth::user();
                        @endphp
                        <img src="{{ filePath($user->avatar) }}" class="rounded-pill" alt="{{ $user->name }}"
                            width="40px" height="40px">

                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('users.profile') }}"><span>@translate(Profile)
                                </span></a></li>
                        <li><a href="{{ route('change.password') }}"><span>@translate(Change Password)</span></a></li>
