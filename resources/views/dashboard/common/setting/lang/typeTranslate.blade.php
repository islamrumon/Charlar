...
@section('main-content')
    <div class="contentbar">
        ...
        <div class="row">
            <div class="m-0">
                <div class="m-0">
                    ...
                    <a class="btn m-2 {{ Request::url() == route('language.type.translate', [$lang->id, 'blog_category_title']) ? 'btn-success' : 'btn-primary' }}"
                        href="{{ route('language.type.translate', [$lang->id, 'blog_category_title']) }}">
        ...
        <div class="card  card-outline">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('language.type.translate.store') }}" method="POST">
                    @csrf
                                ...
                                @foreach ($fields as $key => $value)
                                    <tr class="">
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control value w-100" name="value[]"
                                                value="{{ $value }}">
                                        </td>
                                    </tr>
                                @endforeach
