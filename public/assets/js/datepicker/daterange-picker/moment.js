...
!(function (a, b) {
    ...
    function da(a, b) {
        return c(this._monthsShort)
            ...
            : this._monthsShort[Vd.test(b) ? "format" : "standalone"][
                  a.month()
              ];
    }
    function ea(a, b, c) {
    ...
    function pa(a, b, c, d, e, f, g) {
        ...
        return (
            100 > a && a >= 0 && isFinite(h.getFullYear()) && h.setFullYear(a),
            h
        );
    }
    function qa(a) {
        ...
        for (e = V(b._f, b._locale).match(pd) || [], c = 0; c < e.length; c++)
            (f = e[c]),
                ...
                d &&
                    ...
                    (k += d.length)),
                sd[f]
                    ? (d ? (j(b).empty = !1) : j(b).unusedTokens.push(f),
                      aa(f, d, b))
    ...
    function Sa(b, c) {
        ...
        return c._isUTC
            ? ((e = c.clone()),
              (f =
                  (p(b) || d(b) ? b.valueOf() : Ka(b).valueOf()) - e.valueOf()),
