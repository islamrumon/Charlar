...
(function (e) {
        ...
        h = function (a, b) {
            this instanceof h
                ? (b === l && (b = {}),
                  ...
                  (this.s = e.extend(this.s, h.oDefaults, b)),
    ...
    e.extend(h.prototype, {
        ...
        fnMeasure: function (a) {
            ...
            b.row &&
                ((b.viewport = e.contains(j, this.dom.scroller)
                ...
                this.s.dt.oApi._fnCallbackReg(
                    ...
                    function (c, d) {
                        if (b && a.s.dt.oLoadedState) {
                            ...
                            d.iScrollerTopRow =
                                a.s.dt.oLoadedState.iScrollerTopRow;
                            b = false;
                        } else {
            ...
            if (!this.s.skip && !this.s.ingnoreScroll)
                if (this.s.dt.bFiltered || this.s.dt.bSorted)
                    ...
                    if (
                        ...
                        Math.abs(c - this.s.lastScrollTop) > b.viewport ||
                        this.s.ani ||
                        this.s.forceReposition
                            ? ((d =
                                  parseInt(
                                      this._domain("physicalToVirtual", c) /
                                          b.row,
                                      10
                                  ) - f),
                              (this.s.topRowFloat =
        ...
        _fnDrawCallback: function () {
            ...
            c =
                0 === f
                    ...
                    : f + i >= h
                    ? b.scroll - (h - this.s.topRowFloat) * b.row
                    : this._domain(
                          "virtualToPhysical",
                          this.s.topRowFloat * b.row
                      );
