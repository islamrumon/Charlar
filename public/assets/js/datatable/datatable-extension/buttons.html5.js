(function (e) {
    ...
    function z(a, b) {
        u === q &&
            (u =
                ...
                x
                    .serializeToString(
                        e.parseXML(A["xl/worksheets/sheet1.xml"])
                    )
                    .indexOf("xmlns:r"));
    ...
    p.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            m.messageBottom &&
                (j([m.messageBottom], h), n(h, d.header.length - 1));
            b = o(g, "cols");
            ...
            0 === e("mergeCells", g).children().length &&
                e("mergeCells", g).remove();
            d = new (t || i.JSZip)();
            b = {
                type: "blob",
                mimeType:
    ...
    p.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            a = {
                ...
                content: [
                    { table: { headerRows: 1, body: d }, layout: "noBorders" },
                ],
                styles: {
                    tableHeader: {
                        bold: !0,
