...
(function (c) {
    ...
    c.extend(j.prototype, {
        ...
        _detailsInit: function () {
            var b = this,
                ...
                d = this.c.details;
            "inline" === d.type &&
                (d.target = "td:first-child, th:first-child");
            a.on("draw.dtr", function () {
                b._tabIndexes();
            });
            b._tabIndexes();
    ...
    j.display = {
        ...
        modal: function (b) {
            return function (a, d, e) {
                if (d) c("div.dtr-modal-content").empty().append(e());
                    ...
                    var f = function () {
                        ...
                        g = c('<div class="dtr-modal"/>')
                            ...
                            .append(
                                c('<div class="dtr-modal-background"/>').click(
                                    function () {
                                        f();
                                    }
                                )
                ...
                b &&
                    b.header &&
                    c("div.dtr-modal-content").prepend(
                        "<h2>" + b.header(a) + "</h2>"
                    );
            };
        },
    ...
    j.renderer = {
        listHiddenNodes: function () {
            return function (b, a, d) {
                var e = c(
                        '<ul data-dtr-index="' + a + '" class="dtr-details"/>'
                    ),
                    f = !1;
    ...
    p.register("responsive.recalc()", function () {
        return this.iterator("table", function (b) {
            b._responsive &&
                (b._responsive._resizeAuto(), b._responsive._resize());
        });
    });
    p.register("responsive.hasHidden()", function () {
        var b = this.context[0];
        return b._responsive
            ? -1 !== c.inArray(!1, b._responsive.s.current)
            : !1;
    });
    p.registerPlural(
